...
<template>
  ...
  <section class="transfer-quick" role="dialog" aria-label="传输任务快速预览">
    <header>
      ...
      <button v-if="recentTransfers.length" class="clear-btn" title="清除预览记录（不影响传输队列数据）" @click="clearPreviewRecords">
        <Eraser :size="12" />清除记录
      </button>
