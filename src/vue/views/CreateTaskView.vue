...
.upload-trigger{display:inline-flex;height:36px;align-items:center;justify-content:center;gap:7px;border:1px solid rgb(143 53 183 / .32);border-radius:6px;background:rgb(143 53 183 / .09);padding:0 12px;color:#d292f4;font-size:13px;font-weight:500;transition:border-color .15s ease,background .15s ease,color .15s ease}.upload-trigger:hover{border-color:rgb(143 53 183 / .58);background:rgb(143 53 183 / .16);color:#e9c4f8}.upload-trigger:focus{outline:none}.upload-trigger:focus-visible{box-shadow:0 0 0 2px rgb(143 53 183 / .22)}
</style>
